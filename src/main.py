...
def main():
    ...
    generate_pages_recursive(f"{pwd}content", f"{pwd}template.html", f"{pwd}docs")
...
def generate_page(from_path, template_path, dest_path):
    ...
    template_contents = template_contents.replace('href="/', f'href="{dest_path}/')
    template_contents = template_contents.replace('src="/', f'src="{dest_path}/')
